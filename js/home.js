...
function afficher(n){
	...
	switch(n){
		...
		case 1:
			...
			image.src = "png/projet1/p1_0.png";
		...
		case 2:
			...
			image.src = "png/projet2/p2_0.png";
		...
		case 3:
			...
			image.src = "png/projet3/p3_0.png";
		...
		case 4:
			...
			image.src = "png/projet4/p4_0.png";
		...
		case 5:
			...
			image.src = "png/projet5/p5_0.png";
...
function scroll_img(){
	if(page == 0)
		return;
	pos_img = (pos_img+1) % 4;
	var fileName = "png/projet"+page+"/p"+page+"_"+pos_img+".png";
	if (pos_img<0 || pos_img>3) {
		alert("wrong scroll");
	} else {
		image_proj.src = fileName;
	}
